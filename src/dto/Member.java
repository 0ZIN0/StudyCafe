...
public class Member {
	...
	private Date locker_remain_date;
	...
	public Date getLocker_remain_date() {
		return locker_remain_date;
	}
	public void setLocker_remain_date(Date locker_remain_date) {
		this.locker_remain_date = locker_remain_date;
	}
}
